...
Comments:
    ...
    - {r:@fred}: The name {fred} has been configured to refer to some host, and to 
      provide login credentials. (For more information on configuration, run
      {n:help configuration}.
      

    - {r:[...]}: The command to be executed on {r:fred} is delimited by {r:[...]}
...
Comments:
    ...
    - {r:map (host, file: file.size)}: This function discards the host information, 
