...
{p,wrap=F}
    ...
    - {n:expand}      - {n:fg}          - {n:gen}         - {n:head}
    - {n:help}        - {n:history}     - {n:ifelse}      - {n:ifthen}
    - {n:import}      - {n:intersect}   - {n:jobs}        - {n:join}
    - {n:load}        - {n:ls}          - {n:map}         - {n:popd}
    - {n:ps}          - {n:pushd}       - {n:pwd}         - {n:red}
    - {n:remote}      - {n:reverse}     - {n:run}         - {n:select}
